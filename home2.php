...
<nav class="navbar navbar-inverse bg-inverse fixed-top bg-faded">
    ...
    <div class="row">
        <div class="col">
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#cart">Cart (<span class="total-count"></span>)</button><button class="clear-cart btn btn-danger">Clear Cart</button> <form action="home.php" method="post"><button class="btn btn-primary">logout</button></form></div>
    </div>
</nav>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <form action="payment.php" method="post"><button class="btn btn-primary">Order now</button></form>
